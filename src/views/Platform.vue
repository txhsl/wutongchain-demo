<template>
  <div>
    <el-menu
      ...
      <el-menu-item index="2">积分交易</el-menu-item>
    ...
    <div v-if="isNavSelected('2')">
      <div class="form-box">
        <el-form ref="formRef" :rules="rules" :model="form" label-width="100px">
          ...
          <el-button type="primary" class="mt20" @click="calEEXI">计算EEXI</el-button>
        </el-form>
      </div>
    </div>
      ...
      <el-row>
        <el-col :span="2">
          ...
          >
            ...
            <el-menu-item index="2">EEXI</el-menu-item>
            <el-menu-item index="3">CII</el-menu-item>
            <el-menu-item index="4">我的积分</el-menu-item>
            <el-menu-item index="5">交易记录</el-menu-item>
          </el-menu>
        </el-col>
        <el-col :span="22">
